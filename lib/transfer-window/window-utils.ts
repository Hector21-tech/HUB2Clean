    ...
    switch (windowStatus.status) {
      ...
      case 'CLOSES_SOON':
        const urgencyColor = windowStatus.urgencyLevel === 'critical'
          ? { color: 'bg-red-100 dark:bg-red-900/30', textColor: 'text-red-800 dark:text-red-200', borderColor: 'border-red-200 dark:border-red-700' }
          : windowStatus.urgencyLevel === 'high'
          ? { color: 'bg-orange-100 dark:bg-orange-900/30', textColor: 'text-orange-800 dark:text-orange-200', borderColor: 'border-orange-200 dark:border-orange-700' }
          : { color: 'bg-yellow-100 dark:bg-yellow-900/30', textColor: 'text-yellow-800 dark:text-yellow-200', borderColor: 'border-yellow-200 dark:border-yellow-700' }
